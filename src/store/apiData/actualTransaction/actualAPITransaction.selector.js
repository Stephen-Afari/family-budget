...
const selectActualApiTransactionReducer = (state) => state.actualapitransaction;
...
export const selectActualApiTransaction = createSelector(
    ...
    [selectActualApiTransactionReducer],
    (actualApiTransactionSlice) => actualApiTransactionSlice.actualapitransaction
  );
